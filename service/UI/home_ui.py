...
"border-radius: 10px;")
        ...
        self.speechBalloonImage.setPixmap(QtGui.QPixmap("service/UI/image/speech_balloon.jpg"))
    ...
    def setDogImageBasedOnLevel(self, dog_level):
        ...
        self.dogImage.setPixmap(QtGui.QPixmap(f"service/UI/image/dog_level{dog_level}.png"))
